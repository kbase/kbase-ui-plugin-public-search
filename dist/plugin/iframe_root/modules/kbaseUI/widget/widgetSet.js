...
addWidget(t,i){
const d=i||{},r=this.widgetManager.getWidget(t),a=this.widgetManager.makeWidget(t,d),n=r.name+"_"+e.genId(),g={
id:n,name:r.name||r.id,title:r.title,widgetMaker:a};return this.widgets.push(g),
n}addWidgets(t,e){t.map(t=>this.addWidget(t,e))}makeWidgets(){
...
message:"The widget "+(t.title||t.name)+" does not have a valid node at "+t.id}
