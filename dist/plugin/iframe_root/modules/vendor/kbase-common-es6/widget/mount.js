...
return this.mountedWidget={widget:null,container:null
...
;return this.mountedWidget?(this.mountedWidget.promise.cancel(),
e=this.mountedWidget.widget,
t.try(()=>e.stop&&e.stop()).then(()=>e.detach&&e.detach()).then(()=>{
this.container.innerHTML=""
}).then(()=>e.destroy&&e.destroy()).catch(t=>(console.error("ERROR unmounting widget"),
