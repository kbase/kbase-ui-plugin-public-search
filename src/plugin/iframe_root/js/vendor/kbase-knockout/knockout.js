    ...
    ko.bindingHandlers['foreach'] = {
        makeTemplateValueAccessor: function (valueAccessor) {
            return function () {
                ...
                var unwrappedValue = ko.utils.peekObservable(modelValue);
                ...
                // If unwrappedValue.data is the array, preserve all relevant options and
                // unwrap again value so we get updates.
